...
import Controle.ConVerificaFirewall;
 ...
 * @author Yan
 */
public class VerificaFirewall extends javax.swing.JFrame {
    
    ConVerificaFirewall conArq; 
    /**
     * Creates new form ArquivoConfiguracao
     */
    public VerificaFirewall() {
        initComponents();
        conArq = new ConVerificaFirewall();
        tfUsuario.setText("santana");
        tfSenha.setText("santana@2015");
        tf_filia.setText("132");
        tf_caixa.setText("253");
    ...
    private void initComponents() {
        ...
        jCliberar = new javax.swing.JCheckBox();
        ...
        setTitle("Verificação dos Firewall");
        ...
        jCliberar.setText("Libera");
        jCliberar.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jCliberarActionPerformed(evt);
            }
        });
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addComponent(tf_caixa, javax.swing.GroupLayout.PREFERRED_SIZE, 55, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(jCliberar)
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        conArq.setDirectory(tf_diretorio.getText());
    ...
    private void jCliberarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jCliberarActionPerformed
        if(jCliberar.isSelected()) {
            tf_caixa.setEditable(true);
        } else {
            tf_caixa.setEditable(false);
        }
    }//GEN-LAST:event_jCliberarActionPerformed
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VerificaFirewall.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private javax.swing.JCheckBox jCliberar;
